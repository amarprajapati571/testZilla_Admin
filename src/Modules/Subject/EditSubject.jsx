...
<div className="card mb-3">
    <h4 className="card-header">Edit Subject</h4>
    <div className="card-body">
            <form action="">
                                <div className="form-group">
                                    <label className="form-label">Name of Subject</label>
                                    <input type="text" className="form-control"/>
                                    <small className="invalid-feedback">A block of help text that breaks onto a new line and may extend beyond one line.</small>
                                </div>
